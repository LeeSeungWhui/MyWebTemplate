  ...
  initData: {
    ...
    rowList: [
      ...
      },
      {
        ...
        description: "문의 유형과 처리 상태 정리",
        attachmentName: "customer_request_sample.xlsx",
      },
      {
        id: 11,
        title: "공개 화면 이동 경로 점검",
        status: "done",
        owner: "운영팀",
        amount: 540000,
        createdAt: "2026-02-21",
        description: "고객이 보는 화면 이동 흐름 확인",
        attachmentName: "navigation_checklist.pdf",
      },
      {
        id: 12,
        title: "고객 상담용 샘플 시나리오 작성",
        status: "pending",
        owner: "기획팀",
        amount: 460000,
        createdAt: "2026-02-22",
        description: "상담 전 확인할 샘플 화면 안내 흐름 정리",
        attachmentName: "sample_guide.docx",
      },
    ],
  },
  view: {
