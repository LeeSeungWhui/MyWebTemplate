...
const RadioButton = forwardRef(({
    ...
    const colorClassMapObj = {
        primary: {
            checked: "bg-zinc-900 text-zinc-50 hover:bg-zinc-800 border-zinc-900",
            unchecked: "bg-white border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:border-zinc-400",
        },
        success: {
    ...
    return (
        <label className={`inline-block ${className}`}>
            ...
            <span
                className={`
                    inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 border
                    ${colorClassName}
