...
/**
 * @description 값이 공백이 아닌 문자열인지 판별한다.
...
/**
 * @description 값을 trim된 문자열 또는 null로 정규화한다.
...
/**
 * @description uploadFileInfo 구조에서 URL 후보 필드를 우선순위대로 추출한다.
...
/**
 * @description 다양한 업로드 응답 형태에서 최종 파일 URL을 추출한다.
...
/**
 * @description 파일 첨부 payload를 `{url, name}` 형태로 변환한다.
...
/**
 * @description 업로드 URL/필드명/변환 함수를 조합해 단일 파일 업로더를 생성한다.
