...
// 한글설명: 설명 Hydrates shared store from SSR-provided initial data.
// 한글설명: 설명 Pass userJson (e.g., { userId, name }) and/or sharedPatch (partial shared object).
...
const SharedHydrator = ({ userJson, sharedPatch, config }) => {
  ...
  useEffect(() => {
    if (typeof userJson !== 'undefined') {
      ...
      // 한글설명: 설명 maintain derived lightweight user for convenience
