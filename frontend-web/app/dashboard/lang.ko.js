...
export const LANG_KO = {
  ...
  layoutMeta: {
    ...
    footerLinkList: [
      { linkId: "crud", linkNm: "업무 데이터 관리 샘플", href: "/sample/crud" },
      { linkId: "form", linkNm: "신청/문의 폼 샘플", href: "/sample/form" },
      { linkId: "admin", linkNm: "회원/권한 관리 샘플", href: "/sample/admin" },
      { linkId: "component", linkNm: "UI 컴포넌트 문서", href: "/component" },
