...
const checkboxPropList = [
    ...
    { name: 'dataObj/dataKey?', description: 'EasyObj 필드와 체크 상태를 양방향 바인딩' },
    { name: 'checked/onValueChange?', description: '외부 상태로 제어하는 controlled 모드' },
...
const checkboxExampleSectionList = [
    {
        ...
        eyebrow: 'EXAMPLE 1',
        title: '기본 사용법',
        summary: '단일 체크와 EasyObj 바인딩을 설정·권한 화면에 가까운 밀도로 확인합니다.',
        ...
        <DocSection
            ...
            title="7. 체크박스 (Checkbox)" description={
                <div className="space-y-4 rounded-xl bg-slate-50/80 p-5 text-sm text-slate-700 ring-1 ring-slate-900/5">
                    <p>Checkbox는 약관 동의, 알림 수신, 체크리스트처럼 여러 항목을 독립적으로 켜고 끄는 입력입니다. EasyObj 바인딩과 controlled 모드를 모두 지원하며, 색상 프리셋으로 상태 의미를 함께 전달할 수 있습니다.</p>
                    ...
                    <p className="text-xs text-slate-500">바운드 값은 boolean, <code>Y</code>, <code>1</code> 계열을 체크 상태로 해석합니다.</p>
                </div>
            }
        >
