    ...
    <DocSection
      ...
      description={(
        <View className="space-y-1">
          <Text className="text-gray-700">간단한 드롭다운. value/onValueChange 또는 dataObj/dataKey로 제어하며 dataList.selected도 함께 갱신한다.</Text>
          ...
          <Text className="text-sm text-gray-600">• closeOnSelect?: 선택 후 닫기 여부(단일 기본 true, 다중 기본 false)</Text>
