    ...
    <DocSection
      ...
      description={(
        <View className="space-y-1">
          <Text className="text-gray-700">토글 스위치. checked/onValueChange 또는 dataObj/dataKey로 제어하며 상태 플래그를 dataObj.checked에도 기록한다.</Text>
          <Text className="text-sm text-gray-600">• label?: 스위치 옆 텍스트</Text>
