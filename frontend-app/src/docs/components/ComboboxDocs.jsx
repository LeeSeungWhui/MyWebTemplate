    ...
    <DocSection
      ...
      description={(
        <View className="space-y-1">
          <Text className="text-gray-700">검색 가능한 단일/다중 선택 컴포넌트. value/onValueChange 또는 dataObj/dataKey로 제어한다.</Text>
          <Text className="text-sm text-gray-600">• dataList + valueKey/textKey: 옵션 목록</Text>
          <Text className="text-sm text-gray-600">• placeholder: 버튼 표시 텍스트</Text>
          <Text className="text-sm text-gray-600">• filterable?: 검색 허용 여부</Text>
          <Text className="text-sm text-gray-600">• multi?: 다중 선택 (체크 토글)</Text>
