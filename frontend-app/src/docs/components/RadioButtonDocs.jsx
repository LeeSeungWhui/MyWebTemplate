    ...
    <DocSection
      ...
      description={(
        <View className="space-y-1">
          <Text className="text-gray-700">버튼 형태의 단일 선택 컴포넌트. checked/onValueChange 또는 dataObj/dataKey로 제어한다.</Text>
          ...
          <Text className="text-sm text-gray-600">• checked?/defaultChecked?: 제어/초기 상태</Text>
          <Text className="text-sm text-gray-600">• dataObj?/dataKey?: EasyObj 바인딩</Text>
          <Text className="text-sm text-gray-600">• color?: primary | success | warning | danger | HEX</Text>
