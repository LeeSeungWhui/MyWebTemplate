    ...
    <DocSection
      ...
      description={(
        <View className="space-y-1">
          <Text className="text-gray-700">풀스크린 로딩 오버레이. 메시지는 message prop으로 변경한다.</Text>
          <Text className="text-sm text-gray-600">• message?: 표시할 텍스트</Text>
          <Text className="text-sm text-gray-600">• className?: 추가 스타일링</Text>
        </View>
      )}
    >
