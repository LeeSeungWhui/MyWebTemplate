    ...
    <DocSection
      ...
      description={(
        <View className="space-y-1">
          <Text className="text-gray-700">단일 선택 라디오 버튼. checked/onValueChange 또는 dataObj/dataKey로 제어한다.</Text>
          ...
          <Text className="text-sm text-gray-600">• checked?/defaultChecked?: 제어/비제어 초기 상태</Text>
