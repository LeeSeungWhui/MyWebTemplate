    ...
    <DocSection
      ...
      description={(
        <View className="space-y-1">
          <Text className="text-gray-700">전역 스토어(useGlobalUi)의 showToast로 짧은 배너 알림을 띄운다.</Text>
          <Text className="text-sm text-gray-600">• showToast(message, opts?): type/position/duration 지정</Text>
          <Text className="text-sm text-gray-600">• hideToast(): 수동 닫기 (duration=Infinity 시 사용)</Text>
        </View>
      )}
    >
