  ...
  return [
    {
      component: (
        <View className="space-y-2">
          ...
          />
          <Text className="text-xs text-gray-600">dataObj.enabled = {String(dataObj.enabled)}</Text>
        </View>
      ),
    ...
    },
    {
      component: (
        <View className="space-y-2">
          ...
          />
          <Text className="text-xs text-gray-600">외부 상태와 동기화되는 컨트롤드 모드.</Text>
        </View>
      ),
      ...
      component: (
        <View className="space-y-1">
          ...
          <Text className="text-xs text-gray-600">
            이벤트 핸들러는 checked 값을 전달하며 dataObj.checked 플래그도 채워진다.
          </Text>
        </View>
      ),
