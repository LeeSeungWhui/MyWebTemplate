    ...
    },
    {
      component: (
        <View className="flex-row items-center gap-3 flex-wrap">
          <Lib.Tooltip content="위" placement="top">
            <Lib.Button size="sm">top</Lib.Button>
          </Lib.Tooltip>
          <Lib.Tooltip content="아래" placement="bottom">
            <Lib.Button size="sm">bottom</Lib.Button>
          </Lib.Tooltip>
          <Lib.Tooltip content="왼쪽" placement="left">
            <Lib.Button size="sm">left</Lib.Button>
          </Lib.Tooltip>
          <Lib.Tooltip content="오른쪽" placement="right">
